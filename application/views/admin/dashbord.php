...
<div id="infowrap">
    <div id="infobox">
        ...
        <p><img src="<?php echo base_url(); ?>admin_images/graph.jpg" width="360" height="266" /></p>            
    </div>
    <div id="infobox" class="margin-left">
        <h3>Traffic for July</h3> 
        <p><img src="<?php echo base_url(); ?>admin_images/graph2.jpg" alt="a" width="359" height="266" /></p>
    </div>
    <div id="infobox">
        <h3>Last 5 Orders</h3>
        <table>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td><a href="#">Jennifer Kyrnin</a></td>
                    <td><a href="#">Apple iPhone 3G 8GB</a></td>
                    <td><a href="#"><img src="<?php echo base_url(); ?>admin_images/icons/page_white_link.png" /></a><a href="#"><img src="<?php echo base_url(); ?>admin_images/icons/page_white_edit.png" /></a><a href="#"><img src="<?php echo base_url(); ?>admin_images/icons/page_white_delete.png" /></a></td>
                </tr>
                <tr>
                    <td><a href="#">Mark Kyrnin</a></td>
                    <td><a href="#">Prenosnik HP 530 1,6GHz</a></td>
